...
ADD dockerimage-file/domjudge-6.0.3.tar.gz /domjudge-src
ADD dockerimage-file/build.sh /domjudge-src
...
COPY gitdomjudge/domserver /opt/domjudge/domserver
COPY gitdomjudge/doc /opt/domjudge/doc
COPY ["dockerimage-file/scripts", "/scripts/"]
...
COPY ["dockerimage-file/supervisor", "/etc/supervisor/conf.d/"]
