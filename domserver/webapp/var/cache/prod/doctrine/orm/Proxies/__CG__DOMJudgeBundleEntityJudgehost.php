 ...
 */
class Judgehost extends \DOMJudgeBundle\Entity\Judgehost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'hostname', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'active', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'polltime', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'restrictionid', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'restriction', '' . "\0" . 'DOMJudgeBundle\\Entity\\Judgehost' . "\0" . 'judgings'];
        }
