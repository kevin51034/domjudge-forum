 ...
 */
class TeamAffiliation extends \DOMJudgeBundle\Entity\TeamAffiliation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'affilid', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'externalid', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'shortname', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'name', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'country', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'comments', '' . "\0" . 'DOMJudgeBundle\\Entity\\TeamAffiliation' . "\0" . 'teams'];
        }
